  ...
  <body>
    ...
    <h2>Editando uma Categoria</h2>
        ...
        if (isset($_REQUEST['nome']) && $_REQUEST['nome']!=''
          ...
          $pdo->exec("DELETE FROM categoria WHERE codigo=".$_REQUEST['categoria'].";");

          $sql = "INSERT INTO categoria (codigo,nome,codigo_pai) VALUES (".$_REQUEST['categoria']." ,\"".$_REQUEST['nome']."\",null)";
            if (!$pdo->query($sql)) {
